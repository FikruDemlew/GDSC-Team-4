              ...
              <div className="w-96 text-gray-600 space-y-5 p-4 shadow-xl border rounded-xl">
                  ...
                  >
                      ...
                      <button
                          ...
                          className={`w-full px-4 py-2 text-white font-medium rounded-lg ${isSigningIn ? 'bg-gray-300 cursor-not-allowed' : 'bg-[#10b981] hover:bg-[#059669] hover:shadow-xl transition duration-300'}`}
                      >
